...
BENCHMARK(bm_sort)->Arg(10'000'000)->Unit(benchmark::kMicrosecond);
BENCHMARK(bm_median)->Arg(1'000'000)->Unit(benchmark::kMicrosecond);
BENCHMARK(bm_partial_sort)->Arg(10'000'000)->Unit(benchmark::kMicrosecond);
